...
<div class="menuitem"><p vertical-align:"middle"><a href="register2.php">Swag up</a></p></div></div></div></center></div>
        ...
        <form method="post" action="verify.php">
            ...
            <input name="name" type="text" placeholder="Swagger-name"/> 
            <br> <input name="address" type="text" placeholder="Hood address"/> <br>
            <input name="password" type="password" placeholder="Swagword" /><br/> <br/>
            <input name="password2" type="password" placeholder="Repeat swagword"/><br/>
